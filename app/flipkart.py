...
e = Extractor.from_yaml_file('app/flipkart.yml')
...
# product_data = []
with open("app/urls.txt",'r') as urllist, open('app/flipkart_output.json','w') as flipkartOutput:
    for url in urllist.read().splitlines():
        ...
        if data:
            ...
            try:
                json.dump(data,flipkartOutput)
                flipkartOutput.write("\n")
                print("Done")
            except:
                continue